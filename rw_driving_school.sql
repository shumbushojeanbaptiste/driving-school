...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 26, 2025 at 12:42 PM
...
(11, 'City Center', NULL, 'C123', NULL, 0, '2025-05-28', '1', '2', '3', '4', '5', 1),
(12, 'City Center', '1234567890', 'C1234', '123 Example St', 0, '2025-05-28', '1', '2', '3', '4', '5', 1),
(13, 'Muhima Center', '1234567890', '0788', '123 Example St', 1, '2025-05-28', '1', '2', '3', '4', '5', 1);
...
INSERT INTO `tbl_instructors` (`instructor_id`, `instructor_code`, `first_name`, `familly_name`, `phone`, `email`, `ID_number`, `status`) VALUES
...
(45, 'INS001', 'Jean Baptiste', 'SHUMBUSHO', '1234567890', 'john.doe@example.com', 'ID123456', 3);
...
--
-- Dumping data for table `tbl_licence_permitted`
--

INSERT INTO `tbl_licence_permitted` (`permitted_id`, `school_id`, `center_id`, `license_id`, `status`) VALUES
(1, 1, 2, 3, 1),
(2, 1, 2, 3, 1),
(3, 1, 2, 1, 1);
...
INSERT INTO `tbl_license` (`license_id`, `full_name`, `short_name`, `description`, `status`) VALUES
(1, 'Motorcycles', 'A', 'For two-wheel motorcycles (can be split into A1, A2, etc., depending on engine capacity)', 1),
(2, 'Cars', 'B', 'For light vehicles (typically private cars, vans, and small trucks up to 3.5 tons).', 1),
(3, 'Trucks', 'C', 'For heavy goods vehicles (over 3.5 tons). Suitable for large trucks and cargo vehicles.', 1),
(4, 'Passenger Mini-Buses', 'D', 'For minibuses, buses, and other passenger-carrying vehicles.', 1),
(5, 'Passenger Buses', 'D1', 'For minibuses, buses, and other passenger-carrying vehicles.', 1),
(6, 'Trailers', 'E', 'For towing trailers (usually attached to vehicles in categories B, C, or D). Often seen as B+E, C+E, etc.', 1),
(7, 'Special Machinery', 'F', 'For agricultural tractors, construction machinery, forklifts, etc.', 1);
...
CREATE TABLE `tbl_registration` (
  ...
  `booking_day` float NOT NULL DEFAULT 0,
...
INSERT INTO `tbl_registration` (`reg_id`, `stu_code`, `school_id`, `center_id`, `license_categ`, `booking_day`, `amount`, `due_date`, `sts`) VALUES
(1, 'S123', 1, 2, '2', 15, 10000, '2023-10-14 22:00:00', 1),
(2, 'S123', 1, 2, '2', 15, 10000, '2023-10-14 22:00:00', 1),
(3, 'S123', 1, 2, '2', 15, 10000, '2023-10-14 22:00:00', 1),
(4, 'JB123', 1, 2, '2', 15, 10000, '2023-10-14 22:00:00', 1);
...
(43, NULL, 'Delice ', NULL, '0722369744', NULL, NULL, 3),
(44, NULL, 'angel study in canada', NULL, '0787246579', NULL, NULL, 3),
(45, '123456', ' Jean Baptiste', 'SHUMBUSHO', '+250788644687', 'Jean33@example.com', '4678999888866', 0),
...
(48, 'stude008', 'Jean', 'SHUMBUSHO', '0788644687', 'shumbushojean1@gmail.com', '11997800', 0),
(49, 'stude009', 'Emmanuel', 'NDAYAMBAJE', '0788644687', 'emmy@gmail.com', '119978008753w352', 1),
(50, '25UB336F', 'Jean', 'SHUMBUSHO', '0788644686', 'shumbushojean156@gmail.com', '1199780087534444', 1);
...
(1, '123456', 'Jean Baptiste', ' SHUMBUSHO', '+250788644687', 'Jeam400@example.com', 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', '1', '1', '1', 0, NULL),
...
(5, '250004', 'Jean', ' Baptiste', '+250788644687', 'info@itec.com', '$argon2i$v=19$m=65536,t=4,p=1$QzRhTzlnYjZLYS9YUVNLWQ$okwbEI+s5Omvq3k9VGZHBFBtsC8BvacqDS91N3pUPas', '1', '2', '1', 1, NULL),
(6, '250005', 'Jean', ' Baptiste', '+250788644687', 'info4@itec.com', '$argon2i$v=19$m=65536,t=4,p=1$RS54SC9YdGtBaWwzaHUwNA$iicU1+L5LsvOrKFX+wrQ39EiuEMnhb3m6CNOIvm+Kf8', '1', '1', '1', 1, NULL),
(7, '250006', 'Jean', ' Baptiste', '+250788644687', 'info5@itec.com', '$argon2i$v=19$m=65536,t=4,p=1$Q0V6T0MzbWpPdEw0MWpieA$bE5FUDUd06jreAdPts9YMQQ1IMOlPM6lrkaOp+FjKEo', '3', '1', '7', 0, NULL),
(8, '250007', 'Jean', ' Baptiste', '+250788644687', 'info50@itec.com', '$argon2i$v=19$m=65536,t=4,p=1$anpEbXRSbFBFejZHWXNpZw$UQQIi/1XPLT2J1gYc0A3fzsVZ1tQgeuiE9n4mtsu7zE', '13', '1', '5', 1, NULL),
(9, '250008', 'SHUMBUSHO', 'Jean', '0788644687', 'shumbushojean15@gmail.com', '$argon2i$v=19$m=65536,t=4,p=1$QVhoMnM0RW5UWnoxdEdnNA$FNYWu963fzwADNBVUyv0si119zmtQUVoLEy6Xaks7K4', '9', '3', '5', 1, NULL),
(10, '250009', 'SHUMBUSHO', 'Jean', '0788644687', 'shumbushojean1@gmail.com', '$argon2i$v=19$m=65536,t=4,p=1$bkNQbURiNG1HM0NKTkp3Lw$S3FqXGIxsrTfXBrgtKnBk4gDZ0Sa5GNt+GoS70jRmss', '2', '2', '2', 1, NULL);
...
--
ALTER TABLE `tbl_instructors`
  MODIFY `instructor_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT for table `tbl_licence_permitted`
--
ALTER TABLE `tbl_licence_permitted`
  MODIFY `permitted_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
